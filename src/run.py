...
if __name__ == '__main__':
    ...
    for task in tasks_test:
        ...
        running_action_rewards += reward_data['reward_action'].r_actions
        print(">>>>>>>>>> Reward Info")
    ...
    r_total = 0.0
    for r in rewards:
        r_actions += r['reward_action'].r_actions
        r_total += r['final_reward'].reward
